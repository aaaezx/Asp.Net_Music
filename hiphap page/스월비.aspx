<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="스월비.aspx.cs" Inherits="hiphap_page_스월비" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/스월비-ART GANG MONEY(Feat.Reddy).jpg" />
			</td>
			...
			<td class="auto-style18">스월비<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />하이라이트레코즈<br /><span class="auto-style17" style="color: #000000"><br /></span><span class="auto-style16" style="color: #000000">랩/힙합</td>
			<td style="font-family: '위메프 Bold'">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				ART GANG MONEY (Feat.레디)<br />
				<audio controls>
