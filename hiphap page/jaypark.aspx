<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="jaypark.aspx.cs" Inherits="hiphap_page_jaypa가" %>
        ...
        <table class="auto-style22">
			<tr>
				...
				<td class="auto-style11">
					<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/박재범-Dank.jpg" />
				</td>
				...
				<td class="auto-style18">Jay Park<br />
