<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="백현.aspx.cs" Inherits="RandB_page_백현" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/백현-loveagain.jpg" />
			</td>
			...
			<td class="auto-style18">백현<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />SM<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌, R&amp;B</td>
