...
public partial class RandB_page_딘 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            sourceControl.Src = "~/RandB music/DEAN-04-what2do (Feat. Crush, Jeff Bernat).mp3";
            source.Src = "~/RandB music/21.mp3";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Session["id"] == null)
        {
            ...
            Cmd_1.CommandText = "SELECT * FROM dean";
            Con_1.Open();
        ...
        else
        {
            ...
            else
            {
                ...
                SqlCommand Cmd = new SqlCommand();
                Cmd.Connection = Con;
                Cmd.CommandText = "INSERT INTO dean (comment) VALUES " + "( N'" + TextBox1.Text + "' )";
                Con.Open();
