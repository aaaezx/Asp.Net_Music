<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="딘.aspx.cs" Inherits="RandB_page_딘" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/딘-what2do.jpg" />
			</td>
			...
			<td class="auto-style18">
                <span class="auto-style16">DEAN</span><br class="auto-style17" />
				<br class="auto-style17" />
				<span class="auto-style16">유니버설 뮤직</span><br class="auto-style17" />
				<br class="auto-style17" />
				<span class="auto-style16">R&amp;B, 랩/힙합</span></td>
			<td style="font-family: '위메프 Bold'">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				What 2 do (Feat. Crush, Jeff Bernat)<br />
				<audio controls>
				...
				21<br />
				<audio controls>
					<source src="" id="source" type="audio/mp3" runat="server" />
				</audio>
			</td>
		</tr>
	</table>
