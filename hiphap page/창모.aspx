<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="창모.aspx.cs" Inherits="hiphap_page_창모" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/창모-METEOR.jpg" />
			</td>
			...
			<td class="auto-style18">창모<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />앰비션뮤직<br /><span class="auto-style17" style="color: #000000"><br /></span><span class="auto-style16" style="color: #000000">랩/힙합</td>
			<td style="font-family: '위메프 Bold'">
				...
				빌었어<br />
				<audio controls>
						<source src="" id="source1" type="audio/mp3" runat="server" />
					</audio>
			</td>
		</tr>
	</table>
