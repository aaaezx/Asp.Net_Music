<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="오반.aspx.cs" Inherits="hiphap_page_오반" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/오반-축하해.jpg" />
			</td>
			...
			<td class="auto-style18">오반<br />
                <br />로맨틱 팩토리<br /><span class="auto-style17" style="color: #000000"><br /></span><span class="auto-style16" style="color: #000000">랩/힙합, R&amp;B</td>
