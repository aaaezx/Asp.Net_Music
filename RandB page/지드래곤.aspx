<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="지드래곤.aspx.cs" Inherits="RandB_page_지드래곤" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/지드래곤-무제.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                <br />
                GD<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />YG<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />랩/힙합, R&amp;B<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ>YG<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span></td>
