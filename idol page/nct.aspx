<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="nct.aspx.cs" Inherits="idol_page_nct" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/nct-make a wish.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                nct<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />SM<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌, 랩/힙합<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ><br />아이돌, 랩/힙합</td>
