<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="bts.aspx.cs" Inherits="idol_page_bts" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/방탄소년단-다이너마이트.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                <span class="auto-style16">방탄소년단<br /></span><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br class="auto-style16" />빅<span class="auto-style16">히트<br /></span><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br class="auto-style16" />아<span class="auto-style16">이돌, 랩/힙합<br />
				</sp장르</span></span><span class="auto-style17" style="color: #000000"><br /><span class="auto-style17" style="color: #FFFFFF">ㅇ>아이돌, 랩/힙합</td>
