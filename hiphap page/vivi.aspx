<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="vivi.aspx.cs" Inherits="hiphap_page_vivi" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/비비-KAZINO.jpg" />
			</td>
			...
			<td class="auto-style18">ViVi<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />블록베리<br /><span class="auto-style17" style="color: #000000"><br /></span><span class="auto-style16" style="color: #000000">랩/힙합</td>
			<td style="font-family: '위메프 Bold'">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				사장님 도박은 재미로 하셔야 합니다 (KAZINO)<br />
				<audio controls>
