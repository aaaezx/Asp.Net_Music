<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="ohmygirl.aspx.cs" Inherits="idol_page_ohmygirl" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/오마이걸-돌핀.jpg" />
			</td>
			...
			<td class="auto-style18">오마이걸<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />WM<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌</td>
