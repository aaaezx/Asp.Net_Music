<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="크러쉬.aspx.cs" Inherits="RandB_page_크러쉬" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/크러쉬-놓아줘.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                크러쉬<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />피네이션<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ></td>
