<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="청하.aspx.cs" Inherits="idol_page_청하" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/청하-플레이.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                청하<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />MNH<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ><br />아이돌, 랩/힙합</td>
