<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="r_and_b_last.aspx.cs" Inherits="music_homepage_r_and_b_last" %>
	...
	<table cellpadding="0" cellspacing="0" class="auto-style10">
		...
		<tr>
			<td class="auto-style26" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/r&amp;b image/지드래곤-무제.jpg" PostBackUrl="~/RandB page/지드래곤.aspx" Width="140px" />
			</td>
			...
			<td class="auto-style35" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; 무제</td>
			<td class="auto-style30" style="color: #666666; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666;">G-DRAGON</td>
		</tr>
		<tr>
			<td class="auto-style26" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/r&amp;b image/크러쉬-놓아줘.jpg" PostBackUrl="~/RandB page/크러쉬.aspx" Width="140px" />
			</td>
			...
			<td class="auto-style35" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; 놓아줘 (with 태연)</td>
			<td class="auto-style30" style="color: #666666; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666;">Crush</td>
		</tr>
		<tr>
			<td class="auto-style26" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="~/r&amp;b image/딘-what2do.jpg" PostBackUrl="~/RandB page/딘.aspx" Width="140px" />
			</td>
			<td class="auto-style37" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:Image ID="Image4" runat="server" CssClass="auto-style33" ImageUrl="~/image/music-cloud.png" Width="40px" />
			</td>
			<td class="auto-style35" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp;&nbsp; 21</td>
		...
		<tr>
			<td class="auto-style26" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="~/r&amp;b image/펀치-밤이되니까.jpg" PostBackUrl="~/RandB page/펀치.aspx" Width="140px" />
			</td>
			<td class="auto-style37" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:Image ID="Image5" runat="server" CssClass="auto-style33" ImageUrl="~/image/music-cloud.png" Width="40px" />
			</td>
			<td class="auto-style35" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; 밤이 되니까</td>
			<td class="auto-style30" style="color: #666666; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666;">펀치</td>
		</tr>
		<tr>
			<td class="auto-style31" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/r&amp;b image/헤이즈-작사가.jpg" PostBackUrl="~/RandB page/헤이즈.aspx" Width="140px" />
			</td>
			...
			<td class="auto-style39" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; 작사가</td>
			<td class="auto-style32" style="color: #666666; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666;">헤이즈</td>
		</tr>
		<tr>
			<td class="auto-style31" colspan="0" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/r&amp;b image/백현-loveagain.jpg" PostBackUrl="~/RandB page/백현.aspx" Width="140px" />
			</td>
			<td class="auto-style36" rowspan="0" style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666">
				<asp:Image ID="Image7" runat="server" CssClass="auto-style33" ImageUrl="~/image/music-cloud.png" Width="40px" />
			</td>
			<td class="auto-style39" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; Candy</td>
			<td class="auto-style32" style="color: #666666; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #666666;">백현</td>
		</tr>
		<tr>
			<td class="auto-style31" colspan="0" rowspan="0">
				<asp:ImageButton ID="ImageButton14" runat="server" ImageUrl="~/r&amp;b image/백예린-square.jpg" PostBackUrl="~/RandB page/백예린.aspx" Width="140px" />
			</td>
			...
			<td class="auto-style34" colspan="0" rowspan="0">&nbsp;&nbsp;&nbsp; 0310</td>
			<td class="auto-style32" style="color: #666666">백예린</td>
		</tr>
	</table>
	<table class="auto-style43">
		<tr>
			<td class="auto-style42">
				<asp:ImageButton ID="ImageButton15" runat="server" ImageUrl="~/image/left.png" PostBackUrl="~/music homepage/r_and_b_first.aspx" Width="45px" />
			</td>
