<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="조광일.aspx.cs" Inherits="hiphap_page_조광일" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/조광일-한국.jpg" />
			</td>
			...
			<td class="auto-style18">조광일<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />디핀칼즈 레코즈<br /><span class="auto-style17" style="color: #000000"><br /></span><span class="auto-style16" style="color: #000000">랩/힙합</td>
