<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="zico.aspx.cs" Inherits="hiphap_page_zico" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/hiphap image/지코-summer hate.jpg" />
			</td>
			...
			<td class="auto-style18">ZICO<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />KOZ<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌, 랩/힙합</td>
			<td style="font-family: '위메프 Bold'">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				Summer Hate (Feat. 비)<br />
				<audio controls>
