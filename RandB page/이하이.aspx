<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="이하이.aspx.cs" Inherits="RandB_page_이하이" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/이하이-홀로.jpg" />
			</td>
			...
			<td class="auto-style18">이하이<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />AOMG<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B</td>
