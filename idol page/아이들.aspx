<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="아이들.aspx.cs" Inherits="idol_page_아이들" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/아이들-덤디덤디.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                (여<span class="auto-style16">자)아이들<br /></span><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br class="auto-style16" />CUBE<span class="auto-style16"><br /></span><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br class="auto-style16" />아이돌<br />
			</td>
