<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="redvelvet.aspx.cs" Inherits="idol_page_redvelvet" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/레드벨벳-사이코.jpg" />
			</td>
			...
			<td class="auto-style18">
                <br />
                레드벨벳<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />SM<br />
                <br />
                아이돌<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ>아이돌, 랩/힙합</td>
