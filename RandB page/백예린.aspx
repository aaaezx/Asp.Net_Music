<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="백예린.aspx.cs" Inherits="RandB_page_백예린" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/백예린-square.jpg" />
			</td>
			...
			<td class="auto-style18">백예린<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />블루바이닐<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B, 발라드</td>
