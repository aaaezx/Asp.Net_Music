<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="헤이즈.aspx.cs" Inherits="RandB_page_헤이즈" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/헤이즈-작사가.jpg" />
			</td>
			...
			<td class="auto-style18">헤이즈<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />피네이션<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B</td>
