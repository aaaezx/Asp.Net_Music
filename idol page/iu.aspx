<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="iu.aspx.cs" Inherits="idol_page_iu" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/아이유-에잇.jpg" />
			</td>
			...
			<td class="auto-style18">IU<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />EDAM<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />아이돌, 발라드</td>
			<td style="font-family: 위메프">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				에잇 (Prod. &amp; Feat. SUGA of BTS)<br />
				<audio controls>
