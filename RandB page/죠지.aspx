<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="죠지.aspx.cs" Inherits="RandB_page_죠지" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/죠지-boat.png" />
			</td>
			...
			<td class="auto-style18">죠지<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />크래프트앤준<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B</td>
