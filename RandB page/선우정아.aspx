<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="선우정아.aspx.cs" Inherits="RandB_page_선우정아" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/r&amp;b image/선우정아-도망가자.jpg" />
			</td>
			...
			<td class="auto-style18">선우정아<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />매직스트로베리<br /><span class="auto-style17" style="color: #FFFFFF">ㅇ</span><br />R&amp;B</td>
