<%@ Page Title="" Language="C#" MasterPageFile="~/Stil1.master" AutoEventWireup="true" CodeFile="싹쓰리.aspx.cs" Inherits="idol_page_싹쓰리" %>
	...
	<table class="auto-style22">
		<tr>
			...
			<td class="auto-style11">
				<asp:Image ID="Image2" runat="server" CssClass="auto-style10" Height="250px" ImageUrl="~/idol image/싹쓰리-다시 여기 바닷가.jpg" />
			</td>
			...
			<td class="auto-style18" style="color: #000000">
                <span class="auto-style16">싹쓰리</span><br />
				<br />
				<br />
				<span class="auto-style16">MBC</span><br />
				<br />
				<br />
				<span class="auto-style16">아이돌</span></td>
			<td style="font-family: '위메프 Bold'">
				<asp:Image ID="Image3" runat="server" ImageUrl="~/image/뮤직.png" Width="40px" />
				여름 안에서 (Covered By 싹쓰리)(Feat. 황광희)<br />
				<audio controls>
				...
				다시 여기 바닷가<br />
				<audio controls>
					<source src="" id="socre1" type="audio/mp3" runat="server" />
				</audio>
			</td>
		</tr>
	</table>
